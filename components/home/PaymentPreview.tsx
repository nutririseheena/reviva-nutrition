...
//   return (
//     <motion.div
//       className="mx-auto mt-10 max-w-md rounded-[24px] border border-[#e8e0cf] bg-white px-6 py-5 shadow-sm"
//       initial={{ opacity: 0, y: 16 }}
//       whileInView={{ opacity: 1, y: 0 }}
...
//         style={{ borderColor: "#efe7d5" }}
//       >
//         <span className="text-slate-500">
//           Secure consultation booking • Fees are non-refundable
//         </span>
//       </div>
//     </motion.div>
//   );
